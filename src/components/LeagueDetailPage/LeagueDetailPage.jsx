...
const LeagueDetailPage = (props) => {
  ...
  return (
    <>
      <div className="text-center league-banner rounded mt-5 mb-4">
        <img className="img-fluid" src={strBanner} alt="" />
      </div>
      <Row className="bg-primary rounded p-3 mb-3">
        <Col md={8}>
          <h1>{strLeague}</h1>
      ...
      <div className="text-center h1 text-decoration-none m-5">
        <a href={strFacebook}>
          <FaFacebook />
        </a>
        <a href={strTwitter}>
